...
class CustomTextField extends StatefulWidget {
  const CustomTextField({
    ...
    this.hintText,
    this.hintStyle,
    this.fillColor = AppColors.blackButtonFild,
    this.suffixIcon,
        ...
        suffixIcon: widget.isPassword
            ? GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Icon( obscureText ? Icons.visibility : Icons.visibility_off,color: AppColors.neutral03,)
                ),
              )
            : widget.suffixIcon,
