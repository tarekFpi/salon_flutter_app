  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Obx(
          () {
            switch (privacyController.rxRequestStatus.value) {
              case Status.loading:
                return Center(
                  child: CustomLoader(),
                );
              ...
              case Status.error:
                return GeneralErrorScreen(
                    onTap: () => privacyController.getPrivacyPolicy());
              case Status.completed:
                return Column(
                  children: [
                    HtmlWidget(
                      privacyController.privacyModel.value.privacyPolicy != null
                          ? privacyController.privacyModel.value.privacyPolicy!
                          : '',
                    ),
                  ],
                );
